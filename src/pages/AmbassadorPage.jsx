...
export default function AmbassadorPage() {
  ...
  const benefits = [
    ...
    { icon: '🎫', title: 'Ticket Commission', desc: 'Earn commission on tickets sold for outings you helped bring to OutingStation' },
    { icon: '🎟️', title: 'Early Outings Access', desc: 'See outings before they go public' },
