...
// ✅ FIXED VERSION with all bug fixes
...
const SubmitEventPage = () => {
  const [formData, setFormData] = useState({
    ...
    eventTitle: '',
    eventCategory: '',
    customCategory: '', // ✅ NEW: For "Other" category
    eventType: 'physical',
    eventDescription: '',
  ...
  const [showTerms, setShowTerms] = useState(false); // ✅ NEW: Terms modal state
  ...
  const validate = () => {
    ...
    // ✅ NEW: Validate custom category if "Other" selected
    ...
    if (isEvent) {
      ...
      // ✅ NEW: Validate end date is not before start date
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Try to upload image, but don't fail if it doesn't work (SSL issue in dev)
      if (formData.eventImage) {
        try {
          ...
          console.warn('⚠️ Image upload failed (SSL issue in dev), using placeholder:', uploadError.message);
      ...
      await addDoc(collection(db, 'event_submissions'), {
        ...
        eventCategory: finalCategory, // ✅ USES custom category if "Other"
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-cyan-50 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
          ...
          {/* SECTION 1: Organizer - keeping same */}
          <div className="mb-10">
          ...
          <div className="mb-10">
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {/* ✅ FIXED: Category with "Other" option */}
                <div>
                  ...
                  {/* ✅ NEW: Show custom category input if "Other" selected */}
                ...
                {/* ✅ FIXED: Event Type with text labels instead of icons */}
                {isEvent && (
                  <div>
            ...
            <div className="mb-10">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  {/* ✅ NEW: Show error if end date is before start date */}
          ...
          {/* SECTION 3B: Operating Hours (Places Only) - keeping same */}
          {isPlace && (
            <div className="mb-10">
              <div className="flex items-center mb-6">
                <div className="w-10 h-10 bg-gradient-to-br from-cyan-600 to-blue-600 rounded-full flex items-center justify-center text-white font-bold mr-4">3</div>
          ...
          {/* Continue with Location, Virtual, Ticketing, Image, Additional Info sections - keeping same but skip to save space */}
          {/* I'll add the key section changes below */}

          {/* SECTION 5: Virtual (with LinkedIn Live & Twitter Space) */}
          {isVirtual && (
            <div className="mb-10">
              <div className="flex items-center mb-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <select name="platform" value={formData.platform} onChange={handleChange} className={`w-full px-4 py-3 border-2 ${errors.platform ? 'border-red-500' : 'border-gray-200'} rounded-xl focus:border-cyan-500 focus:outline-none transition`}>
                    ...
                    {/* ✅ FIXED: Now includes LinkedIn Live and Twitter Space */}
