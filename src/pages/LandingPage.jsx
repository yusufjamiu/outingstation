  ...
  <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-white to-cyan-50 pt-8 pb-8 px-4 md:px-6 relative overflow-hidden">
    ...
    <div className="max-w-7xl mx-auto relative z-10">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-4 mb-16">
        {/* Search Bar with Explore Button Inside */}
        <div className="flex items-center bg-white rounded-full shadow-lg px-4 md:px-6 py-3 md:py-4 w-full lg:max-w-4xl gap-2">
          ...
          <select className="outline-none text-gray-600 bg-transparent text-sm md:text-base pr-2">
            <option>Lagos</option>
            <option>Riyadh</option>
            <option>Dubai</option>
          </select>
          <button className="bg-gradient-to-r from-cyan-400 to-cyan-500 text-white px-8 md:px-12 py-3 rounded-full font-medium shadow-lg hover:shadow-xl transition-shadow flex-shrink-0">
            Explore
          </button>
        </div>

        {/* Browse by Category Button */}
        <button className="w-full lg:w-auto bg-white text-gray-700 px-8 py-3 md:py-4 rounded-full font-medium shadow-lg hover:shadow-xl transition-shadow flex items-center justify-center gap-2 flex-shrink-0">
          <Grid size={20} />
          Browse by Category
        </button>
      </div>

      {/* Images Grid - Horizontal Layout for All Screens */}
      <div className="flex flex-col sm:flex-row items-center justify-center gap-6 px-4">
        {/* Left Image with Card */}
        <div className="relative mb-8 sm:mb-0 flex-shrink-0">
          <div className="w-64 h-64 sm:w-72 sm:h-72 md:w-80 md:h-80 bg-gradient-to-br from-orange-200 to-pink-200 rounded-3xl overflow-hidden shadow-xl">
            <img 
          ...
          {/* Trusted Users Card */}
          <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-cyan-400 to-cyan-500 text-white px-6 py-4 rounded-2xl shadow-xl">
            <div className="flex items-center gap-3">
              <div>
                <div className="text-3xl font-bold">12K</div>
                <div className="text-sm opacity-90">Trusted Users</div>
              </div>
        ...
        <div className="flex flex-col gap-6 flex-shrink-0">
          <div className="w-64 h-40 sm:w-72 sm:h-44 md:w-80 md:h-48 bg-gradient-to-br from-blue-200 to-purple-200 rounded-3xl overflow-hidden shadow-xl">
            <img 
          ...
          <div className="w-64 h-40 sm:w-72 sm:h-44 md:w-80 md:h-48 bg-gradient-to-br from-amber-200 to-orange-200 rounded-3xl overflow-hidden shadow-xl">
            <img 
