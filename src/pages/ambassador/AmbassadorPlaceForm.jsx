...
// exactly now. Food Vendors removed (Vendors already covers this, no
// need for a separate category) and Market removed, both confirmed
// directly. Vendors, Computer Lab, and Bank/ATM added — mirrors
// AdminEventForm's CAMPUS_PLACE_SUBCATEGORIES, which needs this same fix.
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <div className="space-y-4">
                  ...
                  time range. Consumers previously had no way to know if hours
                  applied every day or only specific ones. Matches mobile's
