...
import { collection, getDocs, doc, getDoc, updateDoc, arrayUnion, arrayRemove, addDoc, setDoc, deleteDoc, serverTimestamp, increment, query, where } from 'firebase/firestore';
...
export default function CampusPlaces() {
            ...
            return (
              <div key={vendor.id}
                ...
                <div className="p-4">
                  ...
                  <button onClick={(e) => { e.stopPropagation(); if (currentUser) setReportingVendor(vendor); }}
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <div className="relative rounded-2xl overflow-hidden mb-6 shadow-lg">
        ...
        <div className="absolute bottom-4 left-4 right-4 text-white">
          <div className="flex items-end justify-between gap-4">
            ...
            {/* ✅ Follow button — users only, dashboard already requires auth */}
        ...
        <div className="flex gap-2 flex-wrap mb-6">
          {placeSubCategories.map((sub) => (
            <button key={sub.name} onClick={() => setSelectedSubCategory(sub.name)}
              className={`px-3 py-1.5 rounded-full text-xs font-medium transition ${selectedSubCategory === sub.name ? 'bg-cyan-500 text-white' : 'bg-white text-gray-600 border border-gray-200 hover:border-cyan-400'}`}>
              {sub.icon} {sub.name}
            </button>
          ))}
        </div>
            ...
            return (
              <div key={place.id} onClick={() => navigate(`/event/${place.id}`)}
                ...
                <div className="relative" onClick={(e) => e.stopPropagation()}>
                  ...
                  <button onClick={(e) => handleSaveClick(e, place.id)}
                    ...
                    <Heart size={16} className={savedEventIds.includes(place.id) ? 'text-red-500 fill-red-500' : 'text-gray-600'} />
                  </button>
                  {place.isFree && (
                ...
                <div className="p-4">
                  <h3 className="text-sm font-bold text-gray-900 mb-2 group-hover:text-cyan-500 transition line-clamp-2">{place.title}</h3>
      ...
      {reportingVendor && <ReportVendorModal vendor={reportingVendor} onClose={() => setReportingVendor(null)} />}
    </div>
  );
}