...
export default function CategoryBrowse() {
  ...
  return (
    <div className="p-3 sm:p-6 lg:p-8">
          ...
          >
            ...
            <div className="relative z-10 flex items-center gap-3 sm:gap-5 px-4 sm:px-6 w-full">
              ...
              <div className="flex-1 min-w-0">
                ...
                <h3 className="text-white font-bold text-sm sm:text-xl leading-tight truncate">
                  Webinars & Virtual Events
                </h3>
                <p className="text-white/70 text-xs line-clamp-1 hidden sm:block">
                  Join online webinars, workshops and virtual experiences
                </p>
              </div>
      ...
      {/* ✅ Campus Events Banner — bottom */}
      {activeTab === 'events' && !searchQuery && (
        <Link
          to="/dashboard/uni-events"
      ...
      {/* ✅ Campus Places Banner — bottom */}
      {activeTab === 'places' && !searchQuery && (
        <Link
          to="/dashboard/campus-places"
          className="block rounded-xl sm:rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition group"
        >
          <div className="relative w-full h-36 sm:h-52">
            <img
